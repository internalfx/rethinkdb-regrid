...
var _set = function (ctx, filename, options) {
...
util.inherits(_set, FlushWritable)

_set.prototype._write = function (chunk, encoding, cb) {
  co(function *() {
...
_set.prototype._flush = function (cb) {
  co(function *() {
    if (this.file) {
      this.queue.push(this.r.table(this.conf.chunkTable).insert({
        file_id: this.file.id,
