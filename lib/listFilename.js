...
var _listFilename = function (bucket, filename, options) {
...
util.inherits(_listFilename, Readable)

_listFilename.prototype._read = function () {
  co(function *() {
    var file
