...
var _setStream = function (ctx, filename, options) {
...
util.inherits(_setStream, FlushWritable)

_setStream.prototype._write = function (chunk, encoding, cb) {
  co(function *() {
...
_setStream.prototype._flush = function (cb) {
  co(function *() {
    if (this.file) {
      this.queue.push(this.r.table(this.conf.chunkTable).insert({
        file_id: this.file.id,
