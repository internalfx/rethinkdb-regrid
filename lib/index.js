...
var FindMetadata = require('./FindMetadata')
var GetRevisions = require('./GetRevisions')
...
var ReGridBucket = {
  ...
  findMetadata (meta, options) {
    return new FindMetadata(this, meta, options)
  },

  getRevisions (filename, options) {
    return new GetRevisions(this, filename, options)
  },

  delete (file_id) {
    return Delete(this, file_id)
  },

  rename (file_id, filename) {
    return Rename(this, file_id, filename)
  }
