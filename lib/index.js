...
var ReGridBucket = {
  ...
  set (filename, options) {
    return new _set(this, filename, options)
  },

  getId (file_id) {
    return new _getId(this, file_id)
  },

  getFilename (filename, options) {
    return new _getFilename(this, filename, options)
  },
  ...
  watchRegex (pattern, callback) {
    return new _watchRegex(this, pattern, callback)
  },

  watchFilename (filename, callback) {
    return new _watchFilename(this, filename, callback)
  },

  watchMetadata (meta, callback) {
    return new _watchMetadata(this, meta, callback)
  },
